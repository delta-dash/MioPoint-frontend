...
<button
	onclick={requestTags}
	disabled={isLoading}
	class="inline-flex items-center rounded-md bg-indigo-500 px-4 py-2 text-sm font-semibold leading-6 text-white shadow transition duration-150 ease-in-out hover:bg-indigo-400 disabled:cursor-not-allowed disabled:opacity-60"
>
	{#if isLoading}
		<svg
